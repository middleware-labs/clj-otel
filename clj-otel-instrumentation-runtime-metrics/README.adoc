...
ifndef::env-cljdoc[]
image:https://cljdoc.org/badge/org.clojars.middleware-dev/clj-otel-instrumentation-runtime-metrics[cljdoc,link=https://cljdoc.org/d/org.clojars.middleware-dev/clj-otel-instrumentation-runtime-metrics]
endif::[]
