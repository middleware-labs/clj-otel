(ns middleware-dev.clj-otel.sdk.otel-sdk
  "Programmatic configuration of the OpenTelemetry SDK."
  (:require [middleware-dev.clj-otel.api.attributes :as attr]
            [middleware-dev.clj-otel.api.otel :as otel]
            [middleware-dev.clj-otel.propagator.w3c-baggage :as w3c-baggage]
            [middleware-dev.clj-otel.propagator.w3c-trace-context :as w3c-trace]
