(ns middleware-dev.clj-otel.api.trace.span
  "Functions for manipulating spans."
  (:require [clojure.main :as main]
            [middleware-dev.clj-otel.api.attributes :as attr]
            [middleware-dev.clj-otel.api.otel :as otel]
            [middleware-dev.clj-otel.config :refer [config]]
...
(defn span-interceptor
  ...
  handling, see
  [[middleware-dev.clj-otel.api.trace.http/server-span-interceptors]] for
