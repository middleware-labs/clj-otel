...
ifndef::env-cljdoc[]
image:https://cljdoc.org/badge/org.clojars.middleware-dev/clj-otel-exporter-logging[cljdoc,link=https://cljdoc.org/d/org.clojars.middleware-dev/clj-otel-exporter-logging]
endif::[]
