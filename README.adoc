...
----
** Use Clojure functions such as https://cljdoc.org/d/org.clojars.middleware-dev/clj-otel-api/CURRENT/api/middleware-dev.clj-otel.api.trace.span#with-span![`middleware-dev.clj-otel.api.trace.span/with-span!`] to create spans with attributes
+
[source,clojure]
----
